...
2. Из готового bool** сделать граф
3. В графе найти кратчайший путь
4. В принт зеленая "*" для отображения пути
*/

//Graph<int> bool_arr_to_graph(bool** walls, int rows, int columns) {
...
//}
//
//void generate_maze_with_path(int start, int end, int rows, int columns) {
//    bool** walls = generate(start, end, rows, columns).first;
//    DSU<int> maze = generate(start, end, rows, columns).second;
//
//    Graph<int> graph = bool_arr_to_graph(walls, rows, columns);
//
//
//}
